...
def main():
    ...
    path2 = 'trained_models_for_competition/mobilenet_v4.ckpt'
    path3 = 'trained_models_for_competition/mobilenet_v3.ckpt'
    ...
    plt.savefig(os.path.join('trained_models_for_competition', 'confusion_matrix_ensemble_v2_v4_depth_AND_final_test.png'))
