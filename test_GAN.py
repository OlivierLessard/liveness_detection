...
def main():
    ...
    path = 'trained_models_for_competition/sch1_attMap.ckpt'
    ...
    plt.savefig(os.path.join('trained_models_for_competition', 'confusion_matrix_trained_sch1_attMap_final_test.png'))
